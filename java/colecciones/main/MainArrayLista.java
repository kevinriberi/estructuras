...
import lista.Lista;
import implementaciones.ArrayLista;
...
* @see lista.Lista
* @see implementaciones.ArrayLista
* @version 1.0
*/

@SuppressWarnings ("unchecked")
public class MainArrayLista {
	...
	*/
	public static void main(String[] args) {
		...
		Integer d = 3;
		Integer e = 9;
		Lista<Integer> miLista = new ArrayLista (30);
		Lista<Integer> otraLista = new LinkedLista();
		miLista.agregar(a);
		miLista.agregar(b);
		otraLista.agregar(a);
		otraLista.agregar(b);
		...
		System.out.println(miLista);
		ArrayLista <Integer> auxLista = (ArrayLista <Integer>) miLista.subLista(0,4);
