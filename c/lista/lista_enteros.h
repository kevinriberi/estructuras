...
//reemplaza el valor en la posicion por elemento
/* El valor sobreescrito si es exitosa la operacion
/* -1 si la posicion es invalida o si la lista es vacia.*/
...
//funcion que devuelve el promedio con aplazos
/* El promedio si es exitosa la operacion
/* -1 si la lista no contiene elementos */
float promedio_con_aplazos (tipo_lista lista);

//funcion que devuelve el promedio sin aplazos
/* El promedio si es exitosa la operacion
/* -1 si la lista no contiene elementos o si el estudiante no tiene notas aprobadas */
